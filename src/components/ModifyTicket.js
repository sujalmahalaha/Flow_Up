...
const ModifyTicket = (props) => {
    ...
    const handleFormSubmit = async (e) => {
      e.preventDefault();
      const response = await fetch(`https://flow-up06.onrender.com/api/project/modify-ticket/${ticketId}`, {
          method: 'PUT',
          headers: {
    ...
    <div className="card">
        ...
        <div className="card-body">  
            <form onSubmit={handleFormSubmit}>
              ...
              <button type="submit" className="updatebtn btn-primary"><span>UPDATE</span></button>
            </form>
        </div>
    </div>
  )
