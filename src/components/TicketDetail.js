...
const TicketDetail  = (props) => {
    ...
    const fetchTicket = async()=>{
      const response = await fetch(`https://flow-up06.onrender.com/api/project/get-ticket/${ticketId}`, {
        method: 'GET',
        headers: {
  ...
  return (
    <div className="container">
      ...
      <div className="card-header">
        {ticket.ticketNumber}
        <a href={`/project/${ticket.projectName}/modify-ticket/${ticket._id}`} className="modify_btn float-end">MODIFY TICKET</a>
