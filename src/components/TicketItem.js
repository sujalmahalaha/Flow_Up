    ...
    <div className="container my-1">
              <div className="d-flex justify-content-around border border-3 rounded p-2">
                <div className='mx-2'>
                    ...
                    <span className="badge bglight text-dark">{ticket.ticketNumber}</span>
                </div>
                <div className='mx-2'>
                    <span className="badge bgcolor">{ticket.ticketType}</span>
                </div>
                <div className='mx-2'>
                    <span className="badge bgcolor">{ticket.ticketStatus}</span>
                </div>
                <div className='mx-2'>
                    <span className="badge bglight text-dark">{userIdToName(ticket.createdBy)}</span>
                    <i className="fa-solid fa-right-long mx-2"></i>
                    <span className="badge bglight text-dark">{userIdToName(ticket.assignedTo)}</span>
                </div>
                <div className='mx-2'>
